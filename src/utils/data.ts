...
export const DEMO_VENDORS_SEED: Vendor[] = [
  { id:'v1', name:'Himalayan Stays', type:'Stay', areas:['Manali','Kaza'], primary:{name:'Tashi', phone:'+91 98100 00000', whatsapp:'+91 98100 00000', email:'ops@himalayanstays.example'}, rating:4.6, flags:{preferred:true}, docs:[{type:'Hotel License', ref:'HL-89233', expiry:'2026-03-31', status:'Valid'}] },
  { id:'v2', name:'Kaza Jeep Co.', type:'Transfer', areas:['Kaza','Tabo'], primary:{name:'Dorje', phone:'+91 98300 00000', whatsapp:'+91 98300 00000'}, rating:4.2, docs:[{type:'Transport Permit', ref:'TP-5512', expiry:'2025-08-31', status:'Expired'}] },
  { id:'v3', name:'Spiti Guides', type:'Activity', areas:['Kaza'], primary:{name:'Nawang', phone:'+91 98400 00000'}, rating:4.8, flags:{preferred:true} }
];
...
export const DEMO_BATCHES: Batch[] = [
  { id:'b1', tripId:'t1', itineraryId:'it1', name:'Group A', start:'2025-06-01', end:'2025-06-07', seats:{sold:12,total:20}, status:'Confirmed', captainPrimaryId:'c1', captainBackupId:'c2', vendorAssignments:[{type:'Stay', vendorId:'v1'}], guestIds:['g1','g2','g3'], transferPlan:'Day 2 Tawang→Bumla 06:30; Day 4 Pangong loop' },
  { id:'b2', tripId:'t1', itineraryId:'it1', name:'Group B', start:'2025-06-15', end:'2025-06-21', seats:{sold:0,total:20}, status:'On sale', vendorAssignments:[], guestIds:[] }
];

export const DEMO_VENDORS = DEMO_VENDORS_SEED;
